    ...
    return (
        <div className="dependency-tree-container">
            <div className="dependency-container-header">
                ...
                <div className="icon" >
                    <svg onClick={openDependencyTreeModal} width={16} height={16} xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 509 511.54">
